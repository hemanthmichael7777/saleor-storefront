import { ProductOrder, ProductFilterInput } from "@saleor/sdk";
...
export interface ProductList_products_edges_node_category {
  ...
  export interface ProductList_products_edges_node_productType_metadata {
    key: string;
    value: string;
  }
  
  export interface ProductList_products_edges_node_productType {
    metadata: ProductList_products_edges_node_productType_metadata[]
  }
  
  export interface ProductList_products_edges_node_image {
    id: number;
    alt: string | null;
    url: string;
  }
